...
Оригинальный автор: `SeoFernando`  
Модификации и развитие: `NovakovichID`
...
- Пункт `Предпросмотр ответа` открывает полный текст во всплывающем системном окне (не в браузере).
- Используются `zenity` или `kdialog` (fallback: `xmessage`).
